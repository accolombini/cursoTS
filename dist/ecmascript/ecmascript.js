...
function contagemRegressiava(inicio = 5, fim = -5) {
    console.log(inicio);
    while (inicio > fim) {
        inicio--;
        console.log(inicio);
...
// Outro exemplo
const turmaA = ['Maria', 'Joaquim', 'Eduardo'];
const turmaB = ['Julia', 'Roberta', 'Maria'];
...
const tupla = [150, 'Teste', false];
function tuplaParam1(n1, n2, n3) {
...
const usuarioID = 'SuportCode';
const notificacoes = '29';
